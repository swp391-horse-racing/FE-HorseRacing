...
export default function AdminSidebar({ open, onClose, onLogout }) {
  return (
    <aside
      className={`fixed inset-y-0 left-0 z-40 flex w-64 flex-col overflow-hidden border-r border-white/10 bg-[#0F1E3A]/95 backdrop-blur-xl transition-transform duration-200 ${
